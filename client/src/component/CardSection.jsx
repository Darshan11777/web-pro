        ...
        >
          ...
          <div className="flex gap-4 lg:gap-10">
            <div className="button__text mt-4 sm:mt-0">
              <ul>
                <li>
                  <a className="border border-[#ed5959] w-ful inline-block   py-[10px] text-center rounded-[60px] font-poppins font-semibold leading-[48px] text-[20px] text-[#453b57] ml-2 mr-2 px-12">
                    Learn more
                  </a>
                </li>
              </ul>
