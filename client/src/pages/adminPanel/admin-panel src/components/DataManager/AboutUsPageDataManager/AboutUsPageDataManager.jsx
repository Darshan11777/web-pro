...
const AboutUsPageDataManager = () => {
  ...
  const fetchSlides = async () => {
    const res = await axios.get(`${baseUrl}table/about_us_page`);
    setSlides(res.data);
  };
  ...
  const filteredSlides = searchTerm
    ? slides.filter(
        (slide) =>
          slide.section_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
          slide.details.toLowerCase().includes(searchTerm.toLowerCase())
      )
    : slides;
            ...
            <tr key={item.id} className="hover:bg-gray-100">
              <td className="p-4">
                ...
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: highlightSearchTerm(item.section_name),
                  }}
                />
              </td>
              <td className="p-4 max-w-xs">
                <p
                  ...
                  dangerouslySetInnerHTML={{
                    __html: highlightSearchTerm(item.details),
                  }}
                />
              </td>
...
export default AboutUsPageDataManager;
