...
const AboutQuoteSectionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${baseUrl}about-us/quote`, finalData, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchSlide = async () => {
      try {
        const res = await axios.get(`${baseUrl}about-us/quote`, { withCredentials: true });
