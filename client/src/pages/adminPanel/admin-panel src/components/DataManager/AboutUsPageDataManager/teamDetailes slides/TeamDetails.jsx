...
const TeamDetails = () => {
  ...
  const filteredSlides = slides.filter(slide =>
    ...
    slide.role.toLowerCase().includes(searchTerm.toLowerCase()) 
  ...
  const deleteSlide = async (id) => {
    await axios.delete(`${baseUrl}about-us/team-details/${id}`,{withCredentials:true});
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <Breadcrumb pageName="Manage Team Details " />
        ...
        <table className="min-w-full bg-white border border-gray-300 shadow-md rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-gray-200 shadow-2">
              ...
              <th className="p-4 text-left w-1/2 max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">Role</th>
