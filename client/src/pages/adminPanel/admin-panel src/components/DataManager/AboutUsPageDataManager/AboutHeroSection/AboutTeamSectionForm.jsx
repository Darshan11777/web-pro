...
const AboutTeamSectionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`${baseUrl}about-us/team-header`, formData, { withCredentials: true });
  ...
  useEffect(() => {
    const fetchSlide = async () => {
      try {
        const res = await axios.get(`${baseUrl}about-us/team-header`, { withCredentials: true });
  ...
  return (
    <form className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg" onSubmit={handleSubmit}>
      ...
      <div className="space-y-6">
        ...
        {/* Header Line 2 Input */}
        <div className="mb-6">
          <label className="mb-2 block text-black">HighLight Header </label>
          <input
            type="text"
            name="highLight"
...
export default AboutTeamSectionForm;
