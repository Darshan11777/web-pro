...
const ItServicesDetailesSlidesForm = ({ existingData }) => {
...
const dispatch=useDispatch()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (slideId) {
        await axios.put(`${baseUrl}our-services/our-services/${slideId}`, finalData,{withCredentials:true});
      } else {
        await axios.post(`${baseUrl}our-services/our-services`, finalData,{withCredentials:true});
      }
      navigate("../");
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        <label className="mb-2 block text-black">Title</label>
        <input
...
export default ItServicesDetailesSlidesForm;
