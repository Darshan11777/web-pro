...
import SlidesForm from "./OurReviewForm";
...
const Review = () => {
  ...
  const startEditing = (slide) => {
    navigate(`/admin/slides/review/${slide.id}/edit`); // Navigate to edit page
  };
  const addNewSlide = () => {
    navigate("/admin/slides/review/new"); // Navigate to add new slide page
  };
          ...
          {slides.map((slide, i) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h2 className="text-base font-semibold text-gray-800 text-indigo-500">
                  {slide.email}
                </h2>
                <p className="text-lg text-gray-600 mt-2 mb-2 line-clamp-3">
                  {slide.review}
                </p>
