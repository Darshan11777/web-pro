...
const Review = () => {
 ...
 useNavigate();
  ...
  const startEditing = (slide) => {
    navigate(`/admin/slides/review/${slide.id}/edit`);
  };

  const addNewSlide = () => {
    navigate("/admin/slides/review/new");
  };
        ...
        <tbody>
          {currentSlides.map((item) => (
            <tr key={item.id} className="hover:bg-gray-100">
              <td className="p-4">
                <img src={item.imgUrl} alt="" className="w-[60px] aspect-square object-cover rounded-full" />
                </td>
              <td className="p-4">
                <p className="text-sm">
...
<StarRating rating={item.rating} size={20}/>
              ...
              <td className="p-4 ">
                <div className="flex ">
                <button className="hover:text-indigo-500 pr-3" onClick={() => startEditing(item)}>
                ...
                <button className="hover:text-red-500" onClick={() => deleteSlide(item.id)}>
