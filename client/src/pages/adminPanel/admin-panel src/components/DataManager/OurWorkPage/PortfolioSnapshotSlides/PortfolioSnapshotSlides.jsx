...
const PortfolioSnapshotSlides = ({endPoint='our-work/portfolio-snapshot-slides'}) => {
      ...
      <table className="min-w-full bg-white border border-gray-300 shadow-md rounded-lg overflow-hidden">
        <thead >
          <tr className="bg-gray-200 shadow-2  ">
            <th className="p-4 mx-auto text-center w-1/4">Image</th>
            {/* <th className="p-4 text-center w-1/2 max-w-xs overflow-hidden text-ellipsis whitespace-nowrap">
              Description
            </th> */}
            <th className="p-4 text-center w-1/4">Image Number</th>
...
export default PortfolioSnapshotSlides;
