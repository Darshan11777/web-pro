...
import {  aboutUsSchema, contact_us_header_dataSchema, heroSectionSchema, news_header_dataSchema, our_client_header_dataSchema, our_service_headerSchema, our_work_header_dataSchema, ourResultSchema } from "../validators/hero-section/section-header.validator.js";
...
router.put("/our-service", validate(our_service_headerSchema), updateOurServiceHeader);
// our process header
router.get("/our-process", getOurProcessHeader);

router.put("/our-process", validate(our_process_header_dataSchema), updateOurProcessHeader);
// our Work header
router.get("/our-work", getOurWorkHeader);

router.put("/our-work", validate(our_work_header_dataSchema), updateOurWorkHeader);
// our client header
router.get("/our-client", getOurClientHeader);

router.put("/our-client", validate(our_client_header_dataSchema), updateOurClientHeader);
// news header
...
router.put("/contact-us", validate(contact_us_header_dataSchema), updateContactUsHeader);
// our Result Section
